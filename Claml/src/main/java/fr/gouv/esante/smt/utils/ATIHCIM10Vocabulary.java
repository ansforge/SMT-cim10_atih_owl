package fr.gouv.esante.smt.utils;
...
public enum ATIHCIM10Vocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** exclusion.         */ exclusion            ("exclusion",            ANNOTATION_PROPERTY),
    /** hasManifestation.  */ hasManifestation          ("hasManifestation",            ANNOTATION_PROPERTY),
    /** hasCausality.      */ hasCausality          ("hasCausality",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  ATIHCIM10Vocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.ATIHCIM10.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.ATIHCIM10.toString(), localname);
  }

  private static Stream<ATIHCIM10Vocabulary> stream() {
