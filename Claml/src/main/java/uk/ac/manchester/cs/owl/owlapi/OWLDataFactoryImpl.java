...
import static uk.ac.manchester.cs.owl.owlapi.InternalizedEntities.OWL_DISJOINT_WITH;
...
public class OWLDataFactoryImpl implements OWLDataFactory, Serializable, ClassProvider {
    ...
    @Override
    public OWLAnnotationProperty getOWLDisjoint() {
        return OWL_DISJOINT_WITH;
    }
